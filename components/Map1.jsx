...
const Map1 = () => {
    ...
    const filter = useMemo(() => ['in', 'ECO_NAME', selectedRegion], [selectedRegion]);
    ...
    const onClick = useCallback(event => {
        ...
        setClickInfo(clickInfo => [...clickInfo, {
        longitude: event.lngLat[0],
        latitude: event.lngLat[1],
        regionName: region && region.properties.ECO_NAME
        }]);
    ...
    const clickedRegion = (clickInfo && clickInfo.regionName) || '';

    const clickFilter = useMemo(() => ['in', 'ECO_NAME', clickedRegion], [clickedRegion]);
