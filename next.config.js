...
const securityHeaders = [
  ...
  // POSSIBLY UPDATE MORE FOR STRIPE TO WORK AND VERCEL FEEDBACK AND BE MORE SPECIFIC WITH URLS
  {
    ...
    value:
      "default-src 'self'; font-src 'self' https://fonts.gstatic.com; img-src https: data: blob:; script-src 'self' https://vercel.live/_next-live/feedback/feedback.js https://api.mapbox.com https://js.stripe.com https://www.youtube.com/iframe_api https://www.youtube.com/s/player/c353919c/www-widgetapi.vflset/www-widgetapi.js 'unsafe-eval'; style-src 'self'  https://fonts.googleapis.com 'unsafe-inline'; object-src 'none';  connect-src 'self' https://en.wikipedia.org https://api.mapbox.com https://events.mapbox.com https://eco-media-bucket.s3.us-east-2.amazonaws.com ; worker-src 'self' blob:; frame-src https: https://js.stripe.com/ https://www.youtube-nocookie.com/; frame-ancestors 'self'; base-uri 'self'; form-action 'self';",
  },
];
